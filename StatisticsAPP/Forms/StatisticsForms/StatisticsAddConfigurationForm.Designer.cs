namespace StatisticsAPP.Forms.StatisticsForms
{
    partial class StatisticsAddConfigurationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label7 = new Label();
            comboBox_CircleCategory = new ComboBox();
            btn_Save = new Button();
            SuspendLayout();
            // 
            // label1
            ...
            comboBox_Month.Location = new Point(126, 53);
            ...
            comboBox_Year.Location = new Point(126, 105);
            ...
            comboBox_SuperCourt.DropDownStyle = ComboBoxStyle.DropDownList;
            comboBox_SuperCourt.FormattingEnabled = true;
            comboBox_SuperCourt.Location = new Point(126, 20);
            comboBox_SuperCourt.Name = "comboBox_SuperCourt";
            comboBox_SuperCourt.Size = new Size(221, 23);
            ...
            comboBox_CircleMasterType.DropDownStyle = ComboBoxStyle.DropDownList;
            comboBox_CircleMasterType.FormattingEnabled = true;
            comboBox_CircleMasterType.Location = new Point(126, 145);
            comboBox_CircleMasterType.Name = "comboBox_CircleMasterType";
            comboBox_CircleMasterType.Size = new Size(221, 23);
            comboBox_CircleMasterType.TabIndex = 4;
            // 
            // label5
            // 
            ...
            comboBox_SupCourt.DropDownStyle = ComboBoxStyle.DropDownList;
            comboBox_SupCourt.FormattingEnabled = true;
            comboBox_SupCourt.Location = new Point(126, 235);
            comboBox_SupCourt.Name = "comboBox_SupCourt";
            comboBox_SupCourt.Size = new Size(221, 23);
            comboBox_SupCourt.TabIndex = 6;
            // 
            // label7
            // 
            ...
            // 
            // comboBox_CircleCategory
            // 
            comboBox_CircleCategory.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            comboBox_CircleCategory.DropDownStyle = ComboBoxStyle.DropDownList;
            comboBox_CircleCategory.FormattingEnabled = true;
            comboBox_CircleCategory.Location = new Point(126, 191);
            comboBox_CircleCategory.Name = "comboBox_CircleCategory";
            comboBox_CircleCategory.Size = new Size(221, 23);
            comboBox_CircleCategory.TabIndex = 5;
            // 
            // btn_Save
            // 
            btn_Save.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            btn_Save.DialogResult = DialogResult.OK;
            btn_Save.Location = new Point(150, 292);
            ...
            ClientSize = new Size(405, 368);
            Controls.Add(btn_Save);
            Controls.Add(comboBox_CircleMasterType);
            Controls.Add(comboBox_CircleCategory);
            ...
            Load += StatisticsAddConfigurationForm_Load;
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private ComboBox comboBox_CircleCategory;
